...
function scrollHeader(){
    ...
    // When the scroll is greater that 80 viewport height, add the scroll-header class to the header tag
...
function scrollUp(){
    ...
    //When the scroll is higher that 560 viewport height , add the show scroll class to the a tag with the scroll
